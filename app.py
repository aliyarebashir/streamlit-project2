...
with col1:
    ...
    fig.update_layout(title=dict(xanchor='center', yanchor="top", x=0.4, y=0.9, font=dict(size=30)),
                      ...
                      legend_title_font_color="red", title_font_color="violet",
                      height=500,width=500)
    fig.update_layout( {'plot_bgcolor': 'rgba(0, 0, 0, 0.2)'})
    fig.update_yaxes(title="Networth in Billions", title_font_color="blueviolet", tickfont=dict(color="gold"))
    fig.update_xaxes(title="Bilionaires names", title_font_color="blueviolet", tickfont=dict(color="gold"))
    st.plotly_chart(fig)
...
fig.update_layout(title=dict(xanchor='center', yanchor="top", x=0.5, y=0.9, font=dict(size=30)),
                  ...
                  width=1200)
fig.update_layout({'plot_bgcolor': 'rgba(0, 0, 0, 0.2)'})
fig.update_xaxes(title_font_color="blueviolet", tickfont=dict(color="gold"))
fig.update_yaxes(title_font_color="blueviolet", tickfont=dict(color="gold"))
st.plotly_chart(fig)
...
with col5:
    ...
    fig.update_layout(
                      font_color="blueviolet",
                      legend=dict(title="Gender", title_font_color="red"))
    fig.update_layout({'plot_bgcolor': 'rgba(0, 0, 0, 0.2)'})
    st.plotly_chart(fig)
...
fig.update_layout(title=dict(xanchor='center', yanchor="top", x=0.4, y=0.9, font=dict(size=30)),
                  ...
                  legend=dict(title_font_color="red", font_color="violet"),
                  height=600,
                  width=1200
                  )
fig.update_layout({'plot_bgcolor': 'rgba(0, 0, 0, 0.2)'})
...
fig.update_layout(title=dict(xanchor='center',yanchor="top",x=0.5,y=0.9,font=dict(size=30)),
                  title_font_color="lightblue",
                  legend=dict(title="Gender",title_font_color="red",font_color="violet"),
                  font_color="blueviolet",
                  width=1200,
                  height=600)
fig.update_layout({'plot_bgcolor': 'rgba(0, 0, 0, 0.2)'})
